...
def pagina_login():
    ...
    with st.form("login_form"):
        ...
        if submit:
            ...
            if usuario == "Kafra" and senha == "2025":  # Substitua por suas credenciais reais
...
# Página principal (código original)
...
if st.session_state['pagina_atual'] == 'inicial':
    ...
    pagina_login()
elif st.session_state['pagina_atual'] == 'principal' and st.session_state['logado']:
    pagina_principal()
else:
    st.session_state['pagina_atual'] = 'inicial'
    st.rerun()